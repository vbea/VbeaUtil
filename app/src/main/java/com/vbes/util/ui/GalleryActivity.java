...
import com.vbes.util.matisse.model.AlbumCollection;
import com.vbes.util.matisse.model.SelectedItemCollection;
import com.vbes.util.matisse.ui.AlbumPreviewActivity;
import com.vbes.util.matisse.ui.BasePreviewActivity;
import com.vbes.util.matisse.ui.MediaSelectionFragment;
import com.vbes.util.matisse.ui.SelectedPreviewActivity;
import com.vbes.util.matisse.ui.adapter.AlbumMediaAdapter;
import com.vbes.util.matisse.ui.adapter.AlbumsAdapter;
import com.vbes.util.matisse.ui.widget.AlbumsSpinner;
import com.vbes.util.matisse.ui.widget.CheckRadioView;
import com.vbes.util.matisse.ui.widget.IncapableDialog;
import com.vbes.util.matisse.utils.MediaStoreCompat;
...
public class GalleryActivity extends AppCompatActivity implements AlbumCollection.AlbumCallbacks, AdapterView.OnItemSelectedListener, MediaSelectionFragment.SelectionProvider, View.OnClickListener, AlbumMediaAdapter.CheckStateListener, AlbumMediaAdapter.OnMediaClickListener, AlbumMediaAdapter.OnPhotoCapture {
    ...
    public void capture() {
        if (mMediaStoreCompat != null) {
            if (VbeUtil.hasPermission(this, Manifest.permission.CAMERA)) {
                mMediaStoreCompat.dispatchCaptureIntent(this, REQUEST_CODE_CAPTURE);
            } else {
                VbeUtil.requestPermission(this, REQUEST_CODE_PERMISSION, Manifest.permission.CAMERA);
            }
        }
    }
}
